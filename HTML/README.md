...
- if you are using an anchor `<a>`, the order for the css sytling should be:
    ...
    - a:active {color:blue;}
  <p>_for being able to see all the actions active. In here, the link will be in black as default and it will become yellow when there is a mouse hovering over it. While it is being clicking down, the color will be blue and it will turn to pink when it is clicked once._ </p>
